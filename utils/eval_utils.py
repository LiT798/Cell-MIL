...
from models.model_clam import CLAM_SB, CLAM_MB, CLAM_LT
...
def initiate_model(args, ckpt_path, device='cuda'):
    ...
    elif args.model_type == 'maxpooling_mil':
...
def eval(dataset, args, ckpt_path):
    ...
    patient_results, test_error, auc, df, f1, acc_logger = summary(model, loader, args)
...
def summary(model, loader, args):
    ...
    if len(np.unique(all_labels)) == 1:
        ...
        if args.n_classes == 2:
            ...
            f1_score_val = f1_score(all_labels, all_preds)
        else:
            ...
            if args.micro_average:
                ...
                f1_score_val = f1_score(all_labels, all_preds, average='micro')
            else:
    ...
    return patient_results, test_error, auc_score, df, f1_score_val, acc_logger