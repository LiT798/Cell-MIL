...
def main(args):
    ...
    for i in folds:
        ...
        all_test_f1.append(test_f1)  # 添加这行
...
parser.add_argument('--task', type=str, choices=['task_1_tumor_vs_normal',  'task_2_tumor_subtyping', 'task_3_TCGA_Lung', 'task_4_TCGA_BRCA', 'task_5_EndoScell'])
